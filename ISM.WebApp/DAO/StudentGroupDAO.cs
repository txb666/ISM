...
namespace ISM.WebApp.DAO
{
    ...
    {
        List<StudentGroup> GetStudentGroups(int page, int pageSize, int year, string program, string home_univercity, string campus, string coordinator);
        int getTotalStudentGroup(int year, string program, string home_univercity, string campus, string coordinator);
