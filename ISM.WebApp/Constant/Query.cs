...
namespace ISM.WebApp.Constant
{
    ...
    public class NotificationConst
    {
        ...
        public const string GET_ALL_NOTIFICATION_MOBILITY = "select a.[user_id],a.isUpdatePassport,a.isUpdateVisa,a.fullname,a.email,d.[type],d.days_before,d.hours_before,e.expired_date as Passport_Expired,f.expired_date as Visa_Expired,h.[date] as Detail_Agenda_Date,i.[time] as Bus_Time,i.[date] as Bus_Date from Users a, Roles b, Student_Group c, Notification_Configuration d, Passports e, Visa f, Detailed_Agenda h, Transportations i where a.role_id = b.role_id and a.studentGroup_id = c.student_group_id and c.student_group_id = d.studentGroup_id and a.[user_id] = e.student_id and a.[user_id] = f.student_id and c.student_group_id = d.studentGroup_id and c.student_group_id = i.studentGroup_id and b.role_name = 'Mobility'";
    }
